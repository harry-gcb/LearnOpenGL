...
set(AppLib "glfw3 -framework CoreFoundation -framework CoreGraphics -framework IOKit -framework AppKit")
message(STATUS ${LEARN_OPENGL_DIR})
...
target_link_libraries(hello_window_clear ${AppLib})
...
target_link_libraries(hello_triangle_exercise1 ${AppLib})
...
target_link_libraries(hello_triangle_exercise2 ${AppLib})
...
target_link_libraries(hello_triangle_exercise3 ${AppLib})
...
target_link_libraries(shaders_basic ${AppLib})
...
target_link_libraries(shaders_uniform ${AppLib})
...
target_link_libraries(shaders_interpolation ${AppLib})
...
target_link_libraries(shaders_class ${AppLib})
...
target_link_libraries(shaders_exercise2 ${AppLib})
...
target_link_libraries(textures_basic ${AppLib})
...
target_link_libraries(textures_combined ${AppLib})
...
target_link_libraries(textures_exercise2 ${AppLib})
...
target_link_libraries(textures_exercise3 ${AppLib})
...
target_link_libraries(textures_exercise4 ${AppLib})
...
target_link_libraries(transformations ${AppLib})
...
target_link_libraries(transformations_exercise1 ${AppLib})
...
target_link_libraries(transformations_exercise2 ${AppLib})
...
target_link_libraries(coordinate_systems ${AppLib})
